...
一个基于Hexo博客框架的华丽的响应式主题。 

![Tranquilpeak](http://d1u9biwaxjngwg.cloudfront.net/showcases/showcase-v1.4.jpg)

Tranquilpeak主题与Hexo 3.0.x版本兼容。 主题与更高的版本也兼容，但这些版本在生成和关联URL时存在BUG，因此我推荐暂时使用Hexo 3.0.x版本。

本文档将帮助你安装和设置tranquilpeak-hexo-theme，使你能够使用它提供的所有的功能。

如果你想报告一个BUG或提一个问题, [创建一个提问](https://github.com/LouisBarranqueiro/tranquilpeak-hexo-theme/issues/new)。
...
- **作者** : Louis Barranqueiro
- **版本** : 1.4.3
- **兼容性** : Hexo 3.0.0 或更新的版本
